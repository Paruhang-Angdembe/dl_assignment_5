...
from multiclass_model import (
    ...
    define_dense_model_with_hidden_layer,
)
...
def test_define_dense_model_with_hidden_layer():
    model = define_dense_model_with_hidden_layer(
        43,
...
def test_fit_and_predict_mnist_ten_neurons():
    model = define_dense_model_single_layer(
        28 * 28, activation_f="softmax", output_length=10
    )
...
def test_fit_and_predict_mnist_with_hidden_layers():
    model = define_dense_model_with_hidden_layer(
        28 * 28,
        activation_func_array=["sigmoid", "softmax"],
